...
**发布状态：实验版，尚未提交官方市场。** 已验证 GitHub 安装、真实 Codex 钩子发现、离线/HTTP/进程/文件系统测试。真实 Codex 的手动/自动压缩与立即续跑已用本地模拟模型/Jev 验证；真实 Jev API 已验证；真实任务效果对照与官方市场审核仍待完成。[测试报告](docs/TEST-REPORT.md) · [提交草案](docs/SUBMISSION.md)。
